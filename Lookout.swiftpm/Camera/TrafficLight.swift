...
class TrafficLightInput : MLFeatureProvider {
...
@available(macOS 10.14, iOS 12.0, tvOS 12.0, watchOS 5.0, *)
class TrafficLightOutput : MLFeatureProvider {
...
class TrafficLight {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "TrafficLight", withExtension:"mlmodelc")!
    }

    /**
        Construct TrafficLight instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of TrafficLight.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `TrafficLight.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct TrafficLight instance by automatically loading the model from the app's bundle.
    */
    ...
    */
    ...
    /**
        Construct TrafficLight instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct TrafficLight instance asynchronously with optional configuration.
    ...
    */
    ...
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<TrafficLight, Error>) -> Void) {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> TrafficLight {
        return try await self.load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct TrafficLight instance asynchronously with URL of the .mlmodelc directory with optional configuration.
    ...
    */
    @available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<TrafficLight, Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(TrafficLight(model: model)))
            }
        }
    }
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> TrafficLight {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return TrafficLight(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as TrafficLightInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as TrafficLightOutput
    */
    func prediction(input: TrafficLightInput) throws -> TrafficLightOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as TrafficLightOutput
    */
    func prediction(input: TrafficLightInput, options: MLPredictionOptions) throws -> TrafficLightOutput {
        let outFeatures = try model.prediction(from: input, options:options)
        return TrafficLightOutput(features: outFeatures)
    }
    ...
    /**
        ...
        - returns: the result of the prediction as TrafficLightOutput
    */
    func prediction(imagePath: CVPixelBuffer, iouThreshold: Double?, confidenceThreshold: Double?) throws -> TrafficLightOutput {
        let input_ = TrafficLightInput(imagePath: imagePath, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [TrafficLightInput]
           - options: prediction options
        ...
        - returns: the result of the prediction as [TrafficLightOutput]
    */
    func predictions(inputs: [TrafficLightInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [TrafficLightOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [TrafficLightOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  TrafficLightOutput(features: outProvider)
